...
export default function ATFormReportPage() {
  ...
  const { data: vehicle, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      const response = await apiClient.get(`/vehicles/${selectedVehicleId}`);
      ...
      <div className="w-full bg-white border-b border-slate-200 px-6 py-6 lg:px-8 shrink-0 print:hidden">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="flex items-center text-sm text-slate-500 gap-2">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">A.T. Form</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl w-full px-6 lg:px-8 mt-8 print:m-0 print:p-0">
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 mb-8 print:hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
            ...
            <div className="flex-1 max-w-xl">
               <h2 className="text-lg font-semibold text-slate-900 mb-1">A.T. Form Report</h2>
               <p className="text-sm text-slate-500 mb-4">Select a vehicle to generate and preview the A.T. Form.</p>
        ...
        {!selectedVehicleId && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-16 flex flex-col items-center justify-center text-center">
             ...
             <p className="text-slate-500 text-[15px] max-w-sm">Choose a vehicle above to generate the A.T. Form preview.</p>
          </div>
        )}
        ...
        {isLoading && selectedVehicleId && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-16 flex flex-col items-center justify-center text-center">
             ...
             <h3 className="text-lg font-medium text-slate-900 mb-2">Loading A.T. Form...</h3>
          </div>
        )}
        ...
        {isError && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-16 flex flex-col items-center justify-center text-center">
             ...
             <h3 className="text-lg font-medium text-slate-900 mb-2">Unable to generate A.T. Form</h3>
        ...
        {vehicle && !isLoading && !isError && (
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
             ...
             <div className="bg-slate-50 border-b border-slate-200 px-5 py-3 flex flex-wrap items-center justify-between gap-4">
                <h3 className="text-[14px] font-semibold text-slate-700 tracking-wide">A.T. Form Preview</h3>
             ...
             >
                ...
                >
                   <ATFormTemplate vehicle={vehicle} />
                </div>
             </div>
          </div>
        )}
